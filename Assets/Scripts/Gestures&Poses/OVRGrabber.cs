...
public class OVRGrabber : MonoBehaviour
{
    ...
    [SerializeField]
    protected Transform grabbingPoint;
    ...
    public virtual void GrabBeginToPos()
    {
        float closestMagSq = float.MaxValue;
        OVRGrabbable closestGrabbable = null;
        Collider closestGrabbableCollider = null;
        ...
        if (closestGrabbable != null)
        {
            ...
            m_lastPos = grabbingPoint.position;
            m_lastRot = grabbingPoint.rotation;
            ...
            {
                m_grabbedObj.transform.position = grabbingPoint.position;
